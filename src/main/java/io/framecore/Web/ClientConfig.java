...
import io.framecore.Zookeeper.ServerListWatcher;
import io.framecore.Zookeeper.ServerNode;
...
public class ClientConfig {
	...
	public ClientConfig(String targetSystem) {
		try {
			...
			else
			{
				...
				ServerNode sn =	ServerListWatcher.getNode(targetSystem,null);				 
	...
	public ClientConfig(String targetSystem,String method) {
		try {
			...
			else
			{
				...
				ServerNode sn =	ServerListWatcher.getNode(targetSystem,method);				 
